            ...
            <div class="collapse navbar-collapse" id="topnav-menu-content">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link arrow-none" href="{{ route('users.index') }}" id="topnav-dashboard"
                            role="button" aria-haspopup="true" aria-expanded="false">
                            <i class="mdi mdi-view-dashboard me-1"></i> Manage Users</a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-ui" role="button"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="mdi mdi-invert-colors me-1"></i> UI Elements <div class="arrow-down">
                            </div>
                        </a>
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-components">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-extendedui">
                                    ...
                                    <a href="extended-draggable-cards.html" class="dropdown-item">Draggable
                                        Cards</a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-layout" role="button"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="mdi mdi-card-bulleted-settings-outline me-1"></i> Layouts <div class="arrow-down">
                            </div>
                        </a>
